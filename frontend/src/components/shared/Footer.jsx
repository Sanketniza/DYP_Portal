...
import { FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn, FaGithub } from 'react-icons/fa';  // import icons
          ...
          <div className="container ">
            ...
            <div className="flex flex-wrap mx-28">
              ...
              <div className="w-full px-4 md:w-1/4">
                ...
                <div className="flex">
                  <a href="https://github.com/Sanketniza" className="p-2 mr-3 text-white transition duration-300 bg-orange-600 rounded-full hover:bg-orange-500 hover:text-gray-800">
                    <FaGithub />
                  </a>
                  ...
                  <a href="https://www.instagram.com/sanket_talekar1717?igsh=MWV4OHV0dHFydm9ibA==" className="p-2 mr-3 text-white transition duration-300 bg-gray-600 rounded-full hover:bg-white hover:text-gray-800">
                    <FaInstagram />
                  </a>

                  <a href="https://www.linkedin.com/in/sanket-talekar-94087a263" className="p-2 text-white transition duration-300 bg-gray-600 rounded-full hover:bg-white hover:text-gray-800">
                    <FaLinkedinIn />
                  </a>
