...
const Login = () => {
    ...
    return (
        <>
            ...
            <div className='flex items-center justify-center max-w-2xl mx-auto my-10 border rounded-lg shadow shadow-2xl border-emerald-500'>
            
                <form onSubmit={submitHandler} className='w-1/2 p-2 my-10 border border-gray-200 rounded-md'>
                    ...
                    <div className='my-2'>
                        ...
                        <Input
                            ...
                            className="my-2 border-red-500 outline-blue-500"
                        />
                    </div>
                    ...
                    <div className='my-2'>
                        ...
                        <Input
                            ...
                            name="password"
                            onChange={changeEventHandler}
                            placeholder="Student_Hub132@"
                            className="my-2 border-red-500 outline-red-500"
                        />
                    </div>
